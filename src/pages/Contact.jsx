    ...
    <div className="bg-[#F8FAFC] w-full min-h-screen lg:flex whitespace-pre-wrap">
      ...
      <div className="lg:w-1/2 flex flex-col items-center lg:pl-[100px] md:mt-[90px] p-7 mt-10 lg:mr-16 text-[#334155]">
        ...
        <div className="flex flex-col justify-center lg:justify-between">
          <form action="#">
            <input
              className="border flex border-blue-700 m-[25px] pl-5 sm:w-[400px] sm:h-[63px] w-[300px] h-[45px] bg-white rounded-md  hover:border-[1.5px]"
              type="text"
              name="name"
              value={formData.name}
            ...
            />
            <textarea
              className="border flex placeholder:align-top border-blue-700 m-[25px] pl-5 pt-5 sm:w-[400px] sm:min-h-[120px] w-[300px] min-h-[90px] bg-white rounded-md hover:border-[1.5px]"
              type="text"
              name="message"
            ...
            <button
              className=" font-medium sm:w-[400px] sm:h-[70px] w-[300px] h-[50px] mr-[25px] ml-[25px] text-white bg-blue-700 text-xl rounded-lg hover:opacity-90 "
              onClick={submit}
            >
              Send
            </button>
