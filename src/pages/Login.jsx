...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F8FAFC] ">
      ...
      >
        <div className="relative flex w-full flex-col  items-start bg-[#F8FAFC] md:w-1/2">
        ...
        <div className="min-w-sm md:cez min-w-sm flex w-full flex-col items-center justify-center sm:mt-16 md:w-1/2 lg:mt-36">
          ...
          <h3 className="whitespace-nowrap text-center  text-4xl font-bold text-[#334155] sm:mt-0 md:-mr-2  md:-mt-10 lg:text-5xl">
            Log in
          </h3>
          <div className="mt-14 w-[400px] max-w-md">
            <div className="flex flex-col">
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <p className="-mr-0 cursor-pointer whitespace-nowrap text-sm font-medium underline underline-offset-2">
                  Forgot password?
                </p>
              </div>
              <div>
