        ...
        <div className="w-1/2 h-full flex flex-col justify-between">
          ...
          <div className="w-full  h-full flex flex-col  items-center pt-20 pr-[210px] md:p-20  text-[#334155]">
            ...
            <div className="flex flex-col ">
              ...
              <div>
                <button
                  className="bg-[#1D4ED8] mt-8 w-[400px] h-[63px] rounded-md text-center text-18 text-white font-bold"
                  disabled={isLoading}
                >
                  Log in
                </button>
            ...
            {/*<>---------------or-------------------------------</>*/}
            <div className="mt-6 grid grid-cols-3 w-[403px]  items-center text-[#6B7280]">
              <hr className="border-[#6B7280]"></hr>
              <p className="text-center text-16 font-bold ">Or</p>
              <hr className="border-[#6B7280]"></hr>
            </div>
            {/*<>---------------facebook-------------------------------</>*/}
            <div className="mt-6 grid grid-cols-3 items-center gap-5 pl-14  w-[403px]">
              <div className="border-2 border-[#CBD5E1]  rounded-[6px]  w-[60px] h-[60px]">
                <svg
                  className="w-6 h-6 text-blue-600 fill-current m-4"
              ...
              <div className="border-2 border-[#CBD5E1]  rounded-[6px]  w-[60px] h-[60px]">
                <svg
                  className="w-6 h-6 text-blue-500 fill-current m-4"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                >
