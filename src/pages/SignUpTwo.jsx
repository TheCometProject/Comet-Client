...
const SignUpTwo = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="flex flex-col bg-[#F8FAFC]  md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex flex-col lg:mt-28 sm:mt-16 md:mt-32 items-center justify-center min-w-sm">
      ...
      <span className="text-[#1D4ED8] underline cursor-pointer">Log in</span></Link> here
        ...
        <h3 className="text-4xl lg:text-5xl md:-mt-2 md:-mr-2 text-[#334155] whitespace-nowrap  font-bold text-center">
          Sign up
        </h3>
